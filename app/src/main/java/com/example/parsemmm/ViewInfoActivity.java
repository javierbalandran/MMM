    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch(item.getItemId()){
            case R.id.action_faq:
                ...
                i1.putExtra("userid",ID);
                i1.setClass(ViewInfoActivity.this, FaqActivity.class);
                startActivity(i1);
                return true;
            case R.id.action_about:
                Intent i2 = new Intent();
                i2.putExtra("userid",ID);
                i2.setClass(ViewInfoActivity.this, AboutActivity.class);
                startActivity(i2);
                return true;
            case R.id.action_review:
                Intent i3 = new Intent();
                i3.putExtra("userid",ID);
                i3.setClass(ViewInfoActivity.this, ReviewActivity.class);
                startActivity(i3);
                return true;
            default:
